...
function preload(){
  tFont[0] = loadFont("resources/IBMPlexMono-Regular.otf");
  tFont[1] = loadFont("resources/IBMPlexMono-Regular.otf");
  tFont[2] = loadFont("resources/Inter-Medium.ttf");
  tFont[3] = loadFont("resources/IBMPlexMono-Regular.otf");
  tFont[4] = loadFont("resources/IBMPlexMono-Regular.otf");
  tFont[5] = loadFont("resources/IBMPlexMono-Regular.otf");

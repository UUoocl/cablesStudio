/**
 * Ops.Team.CablesStudio.WebHid.SoomfonKeyTexture
 * 
 * Captures a WebGL texture, resizes it to 60x60, and updates a specific key's display on the Soomfon controller via WebHID.
 */
const

/**
 * Ops.Extension.Standalone.Swift.SwiftSoomfonStretchedTexture
 * 
 * Captures a WebGL texture, resizes/flips it to a 180x120 grid (representing the 3x2 display matrix), and sends it to the Swift sidecar.
 */
const

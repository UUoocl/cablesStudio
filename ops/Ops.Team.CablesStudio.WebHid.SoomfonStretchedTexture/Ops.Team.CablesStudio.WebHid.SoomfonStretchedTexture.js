/**
 * Ops.Team.CablesStudio.WebHid.SoomfonStretchedTexture
 * 
 * Captures a WebGL texture, resizes it to 180x120 (representing the 3x2 display matrix), and sends it to the Soomfon controller via WebHID.
 */
const

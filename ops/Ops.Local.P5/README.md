...
| :--- | :--- | :--- |
| **P5 Module URL** | String | URL to the `p5.esm.min.js` file (served by local Fastify). |
| **Sketch URL** | String | URL to your P5 `.js` sketch file. |
| **Canvas Width** | Integer | The target width of the P5 canvas. |
| **Canvas Height** | Integer | The target height of the P5 canvas. |
 ...
 * @param {Number} w - The canvas width set in the Cables Op
 * @param {Number} h - The canvas height set in the Cables Op
 */
export default function(p, op, w, h) {
    let inputData = { x: 0, y: 0 };

    p.setup = () => {
        // Use the passed dimensions or fallback to defaults
    ...
    // Optional: Hook called when the 'Canvas Width/Height' ports change
    p.onResize = (newW, newH) => {

/**
 * Ops.Extension.Standalone.AppleFrameworks.StreamDeckStretchedTexture
 * 
 * Captures a WebGL texture, resizes/flips it to the overall display grid matrix of the Stream Deck, and uploads it.
 */
const

...
function initAddon() {
    ...
    let addonPath = "ops/Ops.Extension.Standalone.AppleFrameworks/Ops.Extension.Standalone.AppleFrameworks.ContourShuttleXpress/contour_shuttle_xpress.node";
    ...
    if (!fs.existsSync(addonPath)) {
        ...
        op.logError("[ContourShuttleXpress] Native addon not found at: " + addonPath);
        return false;
    }
    try {
        ...
        op.logError("[ContourShuttleXpress] Failed to load native addon: " + e.message);
        return false;
    }
}
...
function handleAddonEvent(jsonStr) {
    ...
    try {
        ...
        op.logWarn("[ContourShuttleXpress] Error parsing event payload: " + e.message);
    }
}
...
function ensureInitialized() {
    ...
    try {
        ...
        op.logError("[ContourShuttleXpress] Failed to start native controller: " + e.message);
        return false;
    }
}

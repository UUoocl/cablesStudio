...
function initAddon() {
    ...
    let addonPath = "ops/Ops.Extension.Standalone.AppleFrameworks/Ops.Extension.Standalone.AppleFrameworks.EightBitDoXboxLiteSe/8bitdo_xbox.node";
    ...
    if (!fs.existsSync(addonPath)) {
        ...
        op.logError("[EightBitDoXboxLiteSe] Native addon not found at: " + addonPath);
        return false;
    }
    try {

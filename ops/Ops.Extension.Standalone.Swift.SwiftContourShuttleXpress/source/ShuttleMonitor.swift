...
public final class ShuttleMonitor: @unchecked Sendable {
    ...
    private var prevButtons = Array(repeating: false, count: 5)
    ...
    public func start() -> Bool {
        ...
        thread?.name = "CablesShuttleXpressMonitorThread"
        thread?.start()
